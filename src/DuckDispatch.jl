...
@testitem "Test Basics" begin
    ...
    # Content Generated by @feather macro
    begin
        if !isdefined(@__MODULE__, :collect_ints)
            function collect_ints end
        end
        ...
        function (f::typeof(collect_ints))(arg1; kwargs...)
            wrapped_args = DuckDispatch.wrap_args(f, (arg1,))
